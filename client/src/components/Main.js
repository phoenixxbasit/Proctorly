      ...
      <Link to="/quiz" className="bg-green-500 text-white px-6 py-2 rounded-md font-medium w-full max-w-md text-center">
        ...
        <div className="p-6 flex-grow overflow-y-auto">
          ...
          <ul className="list-disc list-inside">
            <li className="mb-2">
              <span className="font-bold">Quiz 1:</span> 90%
            </li>
            <li className="mb-2">
              <span className="font-bold">Quiz 2:</span> 80%
            </li>
            <li className="mb-2">
              <span className="font-bold">Quiz 3:</span> 70%
            </li>
            <li className="mb-2">
              <span className="font-bold">Quiz 4:</span> 85%
            </li>
            <li className="mb-2">
              <span className="font-bold">Quiz 5:</span> 95%
            </li>
          </ul>
        </div>
      </div>
