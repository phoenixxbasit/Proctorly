        ...
        <div className="pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3">
          <div class="ktq4">
            ...
            <p class="pt-2 value-text text-md text-gray-200 fkrr1">
              By monitoring these addresses, our AI system can quickly detect
              any suspicious activities and stop potential cheaters from
              accessing the exam.
            </p>
          </div>
          <div class="ktq4">
            ...
            <p class="pt-2 value-text text-md text-gray-200 fkrr1">
              Our AI system features eye gaze detection technology that can
              analyze a student's eye movements to detect if they are looking
          ...
          <div class="ktq4">
            ...
            <p class="pt-2 value-text text-md text-gray-200 fkrr1">
              Proctorly uses the latest encryption technology to ensure that all
              data transmitted during the exam is fully encrypted and secure.
            </p>
          </div>
          <div class="ktq4">
            <h3 class="pt-3 font-semibold text-lg text-white">
            ...
            <p class="pt-2 value-text text-md text-gray-200 fkrr1">
              Proctorly is optimized to run smoothly on devices and platforms,
              ensuring that students can take the exam without any lag or
              delays.
            </p>
          </div>
        </div>
